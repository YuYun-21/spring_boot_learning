...
```
sh 'cd wzkj-cloud/ && mvn clean compile install && cd wzkj-admin/ && mvn clean compile install && cd ../wzkj-auth && mvn clean compile install && cd ../wzkj-gateway && mvn clean compile install && cd ../wzkj-wxmp && mvn clean compile install && cd ../wzkj-module/wzkj-agriculture && mvn clean compile install && cd ../wzkj-app && mvn clean compile install && cd ../wzkj-onenet && mvn clean compile install && cd ../wzkj-oss && mvn clean compile install && cd ../wzkj-sys && mvn clean compile install'
```
